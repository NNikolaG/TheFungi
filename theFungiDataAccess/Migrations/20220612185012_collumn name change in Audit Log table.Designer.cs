...
namespace theFungiDataAccess.Migrations
{
    ...
    [Migration("20220612185012_collumn name change in Audit Log table")]
    partial class collumnnamechangeinAuditLogtable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("theFungiDomain.Entities.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("theFungiDomain.Entities.Categories", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("theFungiDomain.Entities.RoleUseCases", b =>
                {
            ...
            modelBuilder.Entity("theFungiDomain.Entities.Collections", b =>
                {
                    b.HasOne("theFungiDomain.Entities.Categories", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("theFungiDomain.Entities.RoleUseCases", b =>
                {
                    b.HasOne("theFungiDomain.Entities.Roles", "Role")
                        .WithMany("UseCases")
